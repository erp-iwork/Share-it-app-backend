# Generated by Django 2.2.13 on 2020-08-08 06:55
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='no-img.png', upload_to=main.models.upload_path)),
                ('cover_img', models.ImageField(default='no-img.png', upload_to=main.models.upload_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('icon', models.ImageField(upload_to=main.models.upload_path)),
                ('name', models.CharField(max_length=255)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main.Category')),
            ],
        ),
