    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(
                    default='no-img.png', upload_to='media/profile_pics')),
                ('cover_img', models.ImageField(
                    default='no-img.png', upload_to='media/cover_pics')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('rater', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                            related_name='user_rater', to=settings.AUTH_USER_MODEL)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='user_rating', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                               related_name='receiver_user', to=settings.AUTH_USER_MODEL)),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                             related_name='sender_user', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ('timestamp',),
            },
        ...
        migrations.CreateModel(
            name='ItemImageModel',
            fields=[
                ('imageId', models.UUIDField(default=uuid.uuid4,
                                             editable=False, primary_key=True, serialize=False)),
                ...
                ('item', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE,
                                           related_name='item_images', to='main.ItemModel')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
